#
#  Be sure to run `pod spec lint StarShareDevUIKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "NetWork for iOS of StarShareDevNetWorking."

  s.homepage     = "https://github.com/StarShare/StarShareDevNetWorking"
  ...
  s.source       = { :git => "https://github.com/StarShare/StarShareDevNetWorking.git", :tag => "0.1.9" }
  ...
  s.source_files  = "StarShareDevNetWorking/StarShareDevNetWorking/**/*.{h,m}"
